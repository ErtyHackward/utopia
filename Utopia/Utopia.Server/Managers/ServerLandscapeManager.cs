...
namespace Utopia.Server.Managers
{
    ...
    public class ServerLandscapeManager : LandscapeManager<ServerChunk>, IDisposable
    {
        ...
        public ServerLandscapeManager(Server server, IChunksStorage chunksStorage, WorldGenerator generator, EntityFactory factory, int chunkLiveTimeMinutes, int cleanUpInterval, int saveInterval, int chunksLimit, WorldParameters wp)
            : base(wp)
        {
