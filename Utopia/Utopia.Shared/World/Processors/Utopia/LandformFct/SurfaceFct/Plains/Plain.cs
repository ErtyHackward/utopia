...
namespace Utopia.Shared.World.Processors.Utopia.LandformFct
{
    public class Plain : ITerrainGenerator
    {
        ...
        {       
            ...
            INoise plain_shape_fractal = new FractalFbm(new Simplex(_seed), 4, 1.7, enuBaseNoiseRange.ZeroToOne);
            ...
            INoise plain_y_scale = new NoiseAccess(plain_scale, NoiseAccess.enuDimUsage.Noise2D, true);
