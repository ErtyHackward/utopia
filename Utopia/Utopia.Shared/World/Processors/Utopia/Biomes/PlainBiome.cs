...
namespace Utopia.Shared.World.Processors.Utopia.Biomes
{
    public class PlainBiome : Biome
    {
        ...
        private BiomeEntity _grassEntities = new BiomeEntity() { EntityId = EntityClassId.Grass, EntityPerChunk = 20, ChanceOfSpawning = 0.4 };
        ...
        private BiomeEntity _flower3Entities = new BiomeEntity() { EntityId = EntityClassId.Flower3, EntityPerChunk = 20, ChanceOfSpawning = 0.4 };
        #endregion
