...
namespace Utopia.Resources.Sprites
{
    public class Sprite3DBillBoardProc : BaseComponent, ISprite3DProcessor
    {
        ...
        private HLSLUtopiaPointSprite3DBillBoard _effect;
        ...
        {
            _effect = ToDispose(new HLSLUtopiaPointSprite3DBillBoard(context.Device, _effectFilePath, VertexPointSprite3D.VertexDeclaration, _frameSharedCB, _sharedCBIncludeHandler));
