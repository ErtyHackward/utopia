...
namespace Utopia.Resources.VertexFormats
{
    ...
    public struct VertexCubeLiquid : IVertexType
    {
        ...
        public VertexCubeLiquid(ref Vector4B position, int textureArrayId, ref ByteColor lighting)
        {
        ...
        public VertexCubeLiquid(ref Vector4B position, int textureArrayId, ref ByteColor lighting, ref Vector4 vertexInfo2, ref Vector4B VertexInfo1)
        {
