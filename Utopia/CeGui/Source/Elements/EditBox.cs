...
public abstract class EditBox : Window {
  ...
  /// <summary>
  ///		Return the text code point index that is rendered closest to screen position point.
  /// </summary>
  /// <param name="point">Point object describing a position on the screen in pixels.</param>
  /// <returns>Code point index into the text that is rendered closest to screen position point.</returns>
