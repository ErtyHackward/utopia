...
namespace S33M3Engines.Struct.Vertex
{
    ...
    public struct VertexCubeLiquid : IVertexType
    {
        ...
        public ByteVector4 VertexInfo1;
        ...
        public VertexCubeLiquid(ref ByteVector4 position, Byte textureArrayId, ref ByteColor lighting)
        {
            this.VertexInfo1 = new ByteVector4();
        ...
        public VertexCubeLiquid(ref ByteVector4 position, Byte textureArrayId, ref ByteColor lighting, ref Vector4 vertexInfo2, ref ByteVector4 VertexInfo1)
        {
