    ...
    public class FirstPersonCamera : Camera
    {
        ...
        public override void Update(ref GameTime TimeSpend)
        {
            ...
            if (CameraPlugin != null)
            {
                ...
                Matrix MRotation = Matrix.Transpose(Matrix.RotationQuaternion(_cameraOrientation.Value));
        ...
        public override void Interpolation(ref double interpolation_hd, ref float interpolation_ld)
        {
            ...
            Matrix MRotation = Matrix.Transpose(Matrix.RotationQuaternion(_cameraOrientation.ValueInterp));
            Matrix.Multiply(ref MTranslation, ref MRotation, out _view_focused);
