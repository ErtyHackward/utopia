...
namespace S33M3Engines.Sprites.GUI
{
    ...
    public class InputInjector
    {
        ...
        /// <summary>
        /// Reads keyboard activity, and injects into CeGui#
        /// HACK (Simon) if gametime is null autorepeat is disabled
        /// </summary>
        public static void processKeyboardInput(GameTime gameTime = null)
        {
            ...
            if ((0 != oldKeys.Length) || (0 != newKeys.Length))
            {
                ...
                if (gameTime == null || addedKeys.Length != 0)
                {
        ...
        {
            return (state.IsKeyDown(Keys.LShiftKey) || state.IsKeyDown(Keys.RShiftKey));
        }
        ...
        private static void press(IEnumerable<Keys> pressed, bool shiftDown)
        {
            ...
            {
                GuiSystem.Instance.InjectKeyDown(k);
        ...
        private static void injectMouseUpDown(MouseButtons button, S33M3Engines.InputHandler.MouseHelper.ButtonState state)
        {
            if (state == S33M3Engines.InputHandler.MouseHelper.ButtonState.Pressed)
        ...
        private static S33M3Engines.InputHandler.MouseHelper.ButtonState leftMouseButtonState;
        /// <summary>Status of the right mouse button</summary>
        private static S33M3Engines.InputHandler.MouseHelper.ButtonState rightMouseButtonState;
