...
namespace S33M3Engines.D3D.DebugTools
{
    public static class GameConsole
    {
        ...
        {
            _spriteRender.Render(_spriteTexture, ref _spriteTexture.ScreenPosition, new Vector4(1, 1, 1, 1), new RectangleF(0, 0, _game.ActivCamera.Viewport.Width, _game.ActivCamera.Viewport.Height / 3));
        }
