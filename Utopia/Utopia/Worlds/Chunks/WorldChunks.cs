    ...
    public partial class WorldChunks : DrawableGameComponent, IWorldChunks
    {
        ...
        public string GetDebugInfo()
        {
            if (ShowDebugInfo)
            {
                ...
                var line2 = string.Format("MetaData : Temperature {0:0.00}, Moisture {1:0.00}, BiomeType : {2}, ColumnMaxHeight : {3}, ChunkID : {4}", columnInfo.Temperature / 255.0f, columnInfo.Moisture / 255.0f, VisualWorldParameters.WorldParameters.Configuration.UtopiaProcessorParam.Biomes[columnInfo.Biome].Name, columnInfo.MaxHeight, c.ChunkID);
                return string.Join("\r\n", line0, line1, line2);
            }
            else
            {
