...
namespace Utopia.Worlds.Cubes
{
    public class SolidCubeMeshFactory : ICubeMeshFactory
    {
        ...
        public SolidCubeMeshFactory(SingleArrayChunkContainer cubesHolder, WorldConfiguration config)
        {
        ...
        public bool FaceGenerationCheck(ref TerraCube cube, ref Vector3I cubePosiInWorld, CubeFaces cubeFace, ref TerraCube NeightBorFaceCube, int seaLevel)
        {
            ...
            CubeProfile NeighborCubeProfile = _config.CubeProfiles[NeightBorFaceCube.Id];
            ...
            switch (cubeFace)
            {
                case CubeFaces.Front:
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _config.CubeProfiles[cube.Id].Tex_Front, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _config.CubeProfiles[cube.Id].Tex_Front, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _config.CubeProfiles[cube.Id].Tex_Front, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _config.CubeProfiles[cube.Id].Tex_Front, ref  newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Back:
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _config.CubeProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _config.CubeProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _config.CubeProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _config.CubeProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Top:
                   ...
                   //Get the 9 Facing cubes to the face
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _config.CubeProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _config.CubeProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _config.CubeProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _config.CubeProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Bottom:
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _config.CubeProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _config.CubeProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _config.CubeProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _config.CubeProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Left:
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _config.CubeProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _config.CubeProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _config.CubeProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _config.CubeProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Right:
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _config.CubeProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _config.CubeProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _config.CubeProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (chunk.CubeVerticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _config.CubeProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
