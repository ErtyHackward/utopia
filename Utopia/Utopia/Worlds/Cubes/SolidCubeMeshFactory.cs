            ...
            switch (cubeFace)
            {
                case CubeFaces.Front:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, (byte)blockProfile.Tex_Front.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Front.AnimationSpeed, blockProfile.Tex_Front.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, (byte)blockProfile.Tex_Front.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Front.AnimationSpeed, blockProfile.Tex_Front.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, (byte)blockProfile.Tex_Front.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Front.AnimationSpeed, blockProfile.Tex_Front.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, (byte)blockProfile.Tex_Front.TextureArrayId, ref  newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Front.AnimationSpeed, blockProfile.Tex_Front.AnimationFrames));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Back:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Back.AnimationSpeed, blockProfile.Tex_Back.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Back.AnimationSpeed, blockProfile.Tex_Back.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Back.AnimationSpeed, blockProfile.Tex_Back.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Back.AnimationSpeed, blockProfile.Tex_Back.AnimationFrames));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Top:
                   ...
                   //Get the 9 Facing cubes to the face
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Top.AnimationSpeed, blockProfile.Tex_Top.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Top.AnimationSpeed, blockProfile.Tex_Top.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Top.AnimationSpeed, blockProfile.Tex_Top.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Top.AnimationSpeed, blockProfile.Tex_Top.AnimationFrames));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Bottom:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Bottom.AnimationSpeed, blockProfile.Tex_Bottom.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Bottom.AnimationSpeed, blockProfile.Tex_Bottom.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Bottom.AnimationSpeed, blockProfile.Tex_Bottom.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Bottom.AnimationSpeed, blockProfile.Tex_Bottom.AnimationFrames));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Left:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Left.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Left.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Left.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Left.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Right:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, (byte)(byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Right.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, (byte)(byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Right.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, (byte)(byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Right.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        //if (chunk.SliceValue > 0 && newColor == ByteColor.Zero) newColor = new ByteColor(0, 0, 0, 40);
                        chunk.Graphics.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, (byte)(byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo, ref biomeInfo, blockProfile.Tex_Right.AnimationSpeed, blockProfile.Tex_Left.AnimationFrames));
                        generatedVertex++;
                    }
