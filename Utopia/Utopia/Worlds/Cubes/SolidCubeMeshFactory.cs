            ...
            switch (cubeFace)
            {
                case CubeFaces.Front:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Front, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Front, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Front, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Front, ref  newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Back:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Back, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Top:
                   ...
                   //Get the 9 Facing cubes to the face
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Top, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Bottom:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Bottom, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Left:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Left, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Right:
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset0) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset1) == false)
                    {
                        ...
                        vertexInfo.X = 1;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref topLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset2) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomLeft, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
                    ...
                    if (verticeDico.TryGetValue(hashVertex, out vertexOffset3) == false)
                    {
                        ...
                        vertexInfo.X = 0;
                        if (chunk.SliceValue > 0) newColor = new ByteColor(0, 0, 0, 255);
                        chunk.SolidCubeVertices.Add(new VertexCubeSolid(ref bottomRight, _wp.WorldParameters.Configuration.BlockProfiles[cube.Id].Tex_Right, ref newColor, ref vertexInfo, ref biomeInfo));
                        generatedVertex++;
                    }
