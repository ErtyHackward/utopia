            ...
            switch (cubeFace)
            {
                case CubeFaces.Front:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, blockProfile.Tex_Front, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, blockProfile.Tex_Front, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, blockProfile.Tex_Front, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, blockProfile.Tex_Front, ref  newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Back:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, blockProfile.Tex_Back, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, blockProfile.Tex_Back, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, blockProfile.Tex_Back, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, blockProfile.Tex_Back, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Top:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, blockProfile.Tex_Top, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, blockProfile.Tex_Top, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, blockProfile.Tex_Top, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, blockProfile.Tex_Top, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Bottom:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, blockProfile.Tex_Bottom, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, blockProfile.Tex_Bottom, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, blockProfile.Tex_Bottom, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, blockProfile.Tex_Bottom, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Left:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, blockProfile.Tex_Left, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, blockProfile.Tex_Left, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, blockProfile.Tex_Left, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, blockProfile.Tex_Left, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Right:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, blockProfile.Tex_Right, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, blockProfile.Tex_Right, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, blockProfile.Tex_Right, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, blockProfile.Tex_Right, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
