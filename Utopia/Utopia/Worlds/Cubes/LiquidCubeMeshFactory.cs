            ...
            switch (cubeFace)
            {
                case CubeFaces.Front:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, (byte)blockProfile.Tex_Front.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, (byte)blockProfile.Tex_Front.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, (byte)blockProfile.Tex_Front.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, (byte)blockProfile.Tex_Front.TextureArrayId, ref  newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Back:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, (byte)blockProfile.Tex_Back.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Top:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, (byte)blockProfile.Tex_Top.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Bottom:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, (byte)blockProfile.Tex_Bottom.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Left:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, (byte)blockProfile.Tex_Left.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                ...
                case CubeFaces.Right:
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topRight, (byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 1;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref topLeft, (byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomLeft, (byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
                    ...
                    if (vertexInDico == false)
                    {
                        ...
                        vertexInfo1.Y = 0;
                        chunk.Graphics.LiquidCubeVertices.Add(new VertexCubeLiquid(ref bottomRight, (byte)blockProfile.Tex_Right.TextureArrayId, ref newColor, ref vertexInfo2, ref vertexInfo1));
                        generatedVertex++;
                    }
