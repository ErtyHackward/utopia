...
namespace Nuclex.UserInterface {
  ...
  public class Screen : IInputReceiver {
    ...
    public void InjectMousePress(System.Windows.Forms.MouseButtons button) {
    ...
    public void InjectMouseRelease(System.Windows.Forms.MouseButtons button) {
      this.heldMouseButtons &= ~button;
  ...
  //  Buttons heldButtons;
    ...
    private System.Windows.Forms.MouseButtons heldMouseButtons;
