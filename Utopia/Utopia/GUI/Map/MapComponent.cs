    ...
    public class MapComponent : GameComponent
    {
        ...
        public override void LoadContent(DeviceContext context)
        {
            ...
            _mapControl = new MapControl
            {
                ...
                PlayerMarker = new SpriteTexture(_engine.Device, playerMarker, new SharpDX.Vector2(), _engine.B8G8R8A8_UNormSupport),
                MapTexture = new SpriteTexture(_engine.Device, _mapImage, new SharpDX.Vector2(), _engine.B8G8R8A8_UNormSupport),
                Bounds = innerBounds
            };
