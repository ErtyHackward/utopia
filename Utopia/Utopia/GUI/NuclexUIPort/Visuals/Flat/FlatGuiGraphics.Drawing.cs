...
namespace Nuclex.UserInterface.Visuals.Flat {
  ...
  partial class FlatGuiGraphics {
    ...
    public void BeginDrawing() {
      ...
      graphics.ScissorRectangle = new System.Drawing.Rectangle(
    ...
    public IDisposable SetClipRegion(RectangleF clipRegion) {
      ...
      System.Drawing.Rectangle scissorRegion = new System.Drawing.Rectangle(
    ...
    public void DrawCustomTexture(Texture2D customTex, Rectangle textureSourceRect, RectangleF bounds)
    {
        ...
        this.spriteBatch.Draw(customTex, destinationRegion, textureSourceRect, Color.White);
