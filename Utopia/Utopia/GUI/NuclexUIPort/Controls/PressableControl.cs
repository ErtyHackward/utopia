...
namespace Nuclex.UserInterface.Controls {
  ...
  public abstract class PressableControl : Control, IFocusable {
    ...
    protected override void OnMousePressed(Nuclex.UserInterface.Input.MouseButtons button) {
      if(this.Enabled) {
        if(button == Nuclex.UserInterface.Input.MouseButtons.Left) {
    ...
    protected override void OnMouseReleased(Nuclex.UserInterface.Input.MouseButtons button) {
      if(button == Nuclex.UserInterface.Input.MouseButtons.Left) {
