...
namespace Nuclex.UserInterface.Controls.Desktop {
  ...
  internal class ChoiceControlTest {
    ...
    public void TestChoiceWithoutParent() {
      ...
      choice.ProcessMousePress(Nuclex.UserInterface.Input.MouseButtons.Left);
      choice.ProcessMouseRelease(Nuclex.UserInterface.Input.MouseButtons.Left);
    ...
    public void TestToggleChoicesByMouse() {
      ...
      this.child2.ProcessMousePress(Nuclex.UserInterface.Input.MouseButtons.Left);
      this.child2.ProcessMouseRelease(Nuclex.UserInterface.Input.MouseButtons.Left);
