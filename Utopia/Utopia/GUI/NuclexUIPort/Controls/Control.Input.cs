...
namespace Nuclex.UserInterface.Controls {
  ...
  partial class Control {
   ...
   /* internal void ProcessButtonRelease(Buttons button) {
    ...
    internal bool ProcessMousePress(Nuclex.UserInterface.Input.MouseButtons button) {
    ...
    internal void ProcessMouseRelease(Nuclex.UserInterface.Input.MouseButtons button) {
    ...
    private Nuclex.UserInterface.Input.MouseButtons heldMouseButtons;
