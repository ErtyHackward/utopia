...
namespace Nuclex.UserInterface {
  ...
  public class Screen : IInputReceiver {
    ...
    public void InjectMousePress(Nuclex.UserInterface.Input.MouseButtons button) {
    ...
    public void InjectMouseRelease(Nuclex.UserInterface.Input.MouseButtons button) {
      this.heldMouseButtons &= ~button;
