...
namespace Utopia.Components
{
    ...
    public class GameSoundManager : GameComponent, IDebugInfo
    {
        ...
        public override void LoadContent(SharpDX.Direct3D11.DeviceContext context)
        {
            ...
            foreach (var biome in _visualWorldParameters.WorldParameters.Configuration.Biomes)
            {
        ...
        private void AmbiantSoundProcessing()
        {
            ...
            Biome chunkBiome = _visualWorldParameters.WorldParameters.Configuration.Biomes[chunk.BlockData.ChunkMetaData.ChunkMasterBiomeType];
