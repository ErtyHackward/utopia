...
using System.Linq;
using System.Text;
using S33M3_CoreComponents.GUI.Nuclex.Controls.Arcade;
...
namespace S33M3_CoreComponents.Debug.GUI.Controls
{
    ...
    public class DebugPerfControl : PanelControl
    {
        ...
        {
            _listOffset = (int)Math.Min(S33M3_CoreComponents.Maths.MathHelper.Lerp(0, _totalItems, _vsc.ThumbPosition), _totalItems - _displayedResults.GetLength(1));
        }
