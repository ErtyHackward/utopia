...
namespace S33M3_CoreComponents.Meshes.Factories.Helpers
{
    /// <summary>
    ...
    public class StringScanner
    {
        ...
        public StringScanner()
        {
            ...
            typePatterns = new Hashtable();
            typePatterns.Add("String", @"[\w\d\S]+");
            typePatterns.Add("Int16", @"[-+]?[0-9]+");
            typePatterns.Add("UInt16", @"[+]?[0-9]+");
            typePatterns.Add("Int32", @"[-+]?[0-9]+");
            typePatterns.Add("UInt32", @"[+]?[0-9]+");
            typePatterns.Add("Int64", @"[-+]?[0-9]+");
            typePatterns.Add("UInt64", @"[+][0-9]+");
            typePatterns.Add("Single", @"[-+]?[0-9]+[.]?[0-9]*|[-+]?\.[0-9]+");
            typePatterns.Add("Double", @"[-+]?[0-9]+[.]?[0-9]*|[-+]?\.[0-9]+");
            typePatterns.Add("Boolean", @"[Tt][Rr][Uu][Ee]|[Ff][Aa][Ll][Ss][Ee]");
            typePatterns.Add("Byte", @"[+]?[0-9]{1,3}");
            typePatterns.Add("SByte", @"[-+]?[0-9]{1,3}");
            typePatterns.Add("Char", @"[\w\S]{1}");
            typePatterns.Add("Decimal", @"[-+]?[0-9]+[.]?[0-9]*|[-+]?\.[0-9]+");
        }
        ...
        public object[] Scan(string text, string fieldSpecification)
        {
            ...
            {
                throw new ScanException("Scan exception", ex);
            }
        ...
        public object[] RefParamHolder(params object[] targets)
        {
            return targets;
        }
        ...
        private object ReturnValue(string typeName, string sValue)
        {
            ...
            switch (typeName)
            {
                ...
                case "Int16":
                    o = Int16.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "UInt16":
                    o = UInt16.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "Int32":
                    o = Int32.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "UInt32":
                    o = UInt32.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "Int64":
                    o = Int64.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "UInt64":
                    o = UInt64.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "Single":
                    o = Single.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "Double":
                    o = Double.Parse(sValue, CultureInfo.InvariantCulture);
                    break;
                ...
                case "Byte":
                    o = Byte.Parse(sValue, CultureInfo.InvariantCulture);
                    break;

                case "SByte":
                    o = SByte.Parse(sValue, CultureInfo.InvariantCulture);
                    break;
                ...
                case "Decimal":
                    o = Decimal.Parse(sValue, CultureInfo.InvariantCulture);
                    break;
            }
            return o;
        }//ReturnValue
