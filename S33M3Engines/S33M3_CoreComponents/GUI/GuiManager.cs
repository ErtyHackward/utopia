...
using S33M3_CoreComponents.GUI.Nuclex.Visuals.Interfaces;
...
using ButtonState = S33M3_CoreComponents.Inputs.MouseHandler.ButtonState;
using Control = S33M3_CoreComponents.GUI.Nuclex.Controls.Control;
using MouseButtons = S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons;
using Screen = S33M3_CoreComponents.GUI.Nuclex.MainScreen;
