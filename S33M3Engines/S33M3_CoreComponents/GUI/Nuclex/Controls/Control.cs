...
namespace S33M3_CoreComponents.GUI.Nuclex.Controls
{
    ...
    ///   </para>
    ///   <para>
    ///     The controls in the S33M3_CoreComponents.GUI.Nuclex library are fully independent of
    ...
    public partial class Control : Component
    {
        ...
        /// </remarks>
        protected virtual void OnMousePressed(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button) { }
        ...
        protected virtual void OnMouseReleased(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button) { OnClicked(); }
