...
namespace S33M3_CoreComponents.GUI.Nuclex.Controls
{
    ...
    partial class Control : Component
    {
        ...
        internal bool ProcessMousePress(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button)
        {
        ...
        internal void ProcessMouseRelease(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button)
        {
        ...
        private S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons heldMouseButtons;
