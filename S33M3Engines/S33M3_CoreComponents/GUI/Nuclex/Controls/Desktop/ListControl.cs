...
using S33M3_CoreComponents.GUI.Nuclex.Controls.Desktop.Interfaces;
...
using S33M3_CoreComponents.GUI.Nuclex.Support.Nuclex.Support.Collections;

namespace S33M3_CoreComponents.GUI.Nuclex.Controls.Desktop
{
    ...
    public class ListControl : Control, IFocusable
    {
        ...
        private readonly VerticalSliderControl _slider;
        ...
        public ListControl()
        {
            ...
            _slider = new VerticalSliderControl();
        ...
        protected override void OnMousePressed(MouseButtons button)
        {
            ...
            {
                int row = _listRowLocator.GetRow(
                    GetAbsoluteBounds(), _slider.ThumbPosition, _items.Count, _mouseY
                    );
        ...
        private void itemRemoved(object sender, ItemEventArgs<object> arguments)
        {
            updateSlider();
        }
        ...
        private void itemAdded(object sender, ItemEventArgs<object> arguments)
        {
            updateSlider();
        }
