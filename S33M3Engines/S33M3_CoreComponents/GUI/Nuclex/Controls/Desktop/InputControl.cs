...
namespace S33M3_CoreComponents.GUI.Nuclex.Controls.Desktop
{
    ...
    public class InputControl : Control, IWritable
    {
                ...
                case Keys.Enter:
                    {
                        ...
                        if (EnterKeyPressed != null) EnterKeyPressed(this, null);
                        return false;
                    }
        ...
        protected override void OnMousePressed(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button)
        {
            if (button == S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons.Left)
            {
        ...
        {
            if (!isMultiline && character == '\r') return;
            OnCharacterEntered(character);
        }
