...
namespace S33M3_CoreComponents.GUI.Nuclex.Input.Interfaces
{
    ...
    ///   Normally, user input is directly fed into the <see cref="MainScreen" /> class
    ...
    public interface IInputReceiver
    {
        ...
        void InjectMousePress(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button);
        ...
        void InjectMouseRelease(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button);
