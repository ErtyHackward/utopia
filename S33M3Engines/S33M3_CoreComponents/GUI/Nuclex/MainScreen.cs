...
using S33M3_CoreComponents.GUI.Nuclex.Support;
using S33M3_CoreComponents.GUI.Nuclex.Input.Interfaces;
using S33M3_CoreComponents.GUI.Nuclex.Input;
using S33M3_CoreComponents.GUI.Nuclex.Controls.Interfaces;


namespace S33M3_CoreComponents.GUI.Nuclex 
{
  ...
  ///   typical GUI library, the S33M3_CoreComponents.GUI.Nuclex library can handle any number of
  ...
  public class MainScreen : IInputReceiver {
    ...
    public void InjectKeyPress(System.Windows.Forms.Keys keyCode)
    {
        ...
        else
        {
            switch (keyCode)
            {
                case System.Windows.Forms.Keys.Up: { InjectCommand(Command.Up); break; }
                case System.Windows.Forms.Keys.Down: { InjectCommand(Command.Down); break; }
                case System.Windows.Forms.Keys.Left: { InjectCommand(Command.Left); break; }
                case System.Windows.Forms.Keys.Right: { InjectCommand(Command.Right); break; }
                case System.Windows.Forms.Keys.Enter: { InjectCommand(Command.Accept); break; }
                case System.Windows.Forms.Keys.Escape: { InjectCommand(Command.Cancel); break; }
            }
        }
    }
    ...
    public void InjectKeyRelease(System.Windows.Forms.Keys keyCode)
    {
    ...
    public void InjectMousePress(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button)
    {
    ...
    public void InjectMouseRelease(S33M3_CoreComponents.GUI.Nuclex.Input.MouseButtons button)
    {
        this.heldMouseButtons &= ~button;
    ...
    private static readonly int maxKeyboardKey =
      (int)EnumHelper.GetHighestValue<System.Windows.Forms.Keys>();
