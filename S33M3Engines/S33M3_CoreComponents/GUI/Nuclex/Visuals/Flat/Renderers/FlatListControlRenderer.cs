...
namespace S33M3_CoreComponents.GUI.Nuclex.Visuals.Flat.Renderers
{

    /// <summary>Renders text input controls in a traditional flat style</summary>
    public class FlatListControlRenderer : IFlatControlRenderer<ListControl>, IListRowLocator
    {
        ...
        public float GetRowHeight(RectangleF bounds)
        {
            ...
            {
                this.rowHeight = graphics.MeasureString("list",ref bounds, "qyjpMAW!").Height;
                this.rowHeight += 2.0f;
            }
