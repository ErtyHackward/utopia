...
namespace S33M3_CoreComponents.GUI.Nuclex.Visuals.Flat
{
    ...
    partial class FlatGuiGraphics
    {
            ...
            )
            {
                ...
                foreach (XElement element in frameElement.Descendants("text"))
                {
                    ...
                    var text = new Frame.Text()
                    {
                        ...
                        Offset = new System.Drawing.Point(xOffset, yOffset),
                        Color = color
                    };
                    texts.Add(text);
                }
        ...
        private void loadSkin(Stream skinStream)
        {
            ...
            using (FileStream schemaStream = new FileStream(@"GUI\Skins\skin.xsd", FileMode.Open, FileAccess.Read, FileShare.Read))
            {
