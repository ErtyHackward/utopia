...
{
    public class Sprite3DImpostorProc : BaseComponent, ISprite3DProcessor
    {
        ...
        private HLSLPointSprite3DImpostor _effect;
        ...
        #endregion
        public Sprite3DImpostorProc(ShaderResourceView texture, SamplerState SpriteSampler, Include sharedCBIncludeHandler, iCBuffer frameSharedCB)
        {
            _texture = texture;
        ...
        {
            _effect = ToDispose(new HLSLPointSprite3DImpostor(context.Device, @"Effects\Sprites\PointSprite3DImpostor.hlsl", VertexPointSprite3D.VertexDeclaration, _frameSharedCB, _sharedCBIncludeHandler));
