...
namespace S33M3CoreComponents.Noises.Generator
{
    ...
    /// </summary>
    /// </summary>
    public class SimplexPerlin : ImprovedPerlin, INoise3, INoise2
    {
        ...
        public SimplexPerlin(int seed)
            : base(seed, enuNoiseQuality.Standard)
        {
        }

        #region INoise4 Members
        ...
        /// </summary>
        /// <param name="x">The input coordinate on the x-axis.</param>
        /// <param name="z">The input coordinate on the y-axis.</param>
        /// <returns>The resulting output value.</returns>
        public new float GetValue(float x, float z)
        {
            ...
            int i = MathHelper.Fastfloor(x + s);
            int j = MathHelper.Fastfloor(z + s);
