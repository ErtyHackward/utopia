...
namespace S33M3CoreComponents.Models.ModelMesh
{
    ...
    public struct ModelMesh_PNTC : IModelMeshComponents
    {
        //Data Layout
        ...
        public static readonly ModelMesh.ModelMeshComponents Components = ModelMesh.ModelMeshComponents.P | ModelMesh.ModelMeshComponents.N | ModelMesh.ModelMeshComponents.T | ModelMesh.ModelMeshComponents.C;

        //Input elements definition
        static ModelMesh_PNTC()
        {
