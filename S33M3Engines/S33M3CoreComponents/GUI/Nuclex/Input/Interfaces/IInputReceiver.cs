...
namespace S33M3CoreComponents.GUI.Nuclex.Input.Interfaces
{
    ...
    public interface IInputReceiver
    {
        ...
        void InjectMousePress(S33M3CoreComponents.GUI.Nuclex.Input.MouseButtons button);
        ...
        void InjectMouseRelease(S33M3CoreComponents.GUI.Nuclex.Input.MouseButtons button);
