...
namespace S33M3CoreComponents.GUI.Nuclex 
{
  ...
  public class MainScreen : IInputReceiver {
    ...
    public void InjectMousePress(S33M3CoreComponents.GUI.Nuclex.Input.MouseButtons button)
    {
    ...
    public void InjectMouseRelease(S33M3CoreComponents.GUI.Nuclex.Input.MouseButtons button)
    {
        this.heldMouseButtons &= ~button;
