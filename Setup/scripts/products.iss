...
ru.depinstall_missing=%1 должен быть установлен для установки О-ГО. Пожалуйста установите %1 и запустите установку заново.

ru.depinstall_error=Во время установки зависимостей произошла ошибка. Перезагрузите компьютер и запустите установку заново, либо утсановите следующие компоненты вручную:%n
